...
class TestColorEnum:
    ...
    def test_color_is_strenum(self):
        """Test Color inherits from StrEnum."""
        from enum import StrEnum
        assert issubclass(Color, StrEnum)

    def test_all_required_colors_defined(self):
...
class TestAllColorsEnum:
    ...
    def test_allcolors_is_strenum(self):
    ...
    def test_regular_colors_defined(self):
...
class TestColorUsage:
    ...
    def test_all_active_colors_work(self, color):
    ...
    def test_color_values_unique(self):
