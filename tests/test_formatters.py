...
class TestCleanupDeviceName:
    ...
    def test_passthrough_markers(self):
    ...
    def test_remove_pci_prefix(self):
    ...
    def test_remove_usb_prefix(self):
    ...
    def test_remove_corporate_suffixes(self):
    ...
    def test_remove_technical_terms(self):
...
class TestCleanupIspName:
    ...
    def test_remove_as_number(self):
    ...
    def test_combined_as_and_suffix(self):
