...
class TestGetAllIpv4Addresses:
    ...
    def test_parse_single_interface(self, mock_run: MagicMock) -> None:
...
2: eth0: <BROADCAST,MULTICAST,UP,LOWER_UP> mtu 1500
    ...
    @patch("network.ip_routing.run_command")
    def test_multiple_addresses_takes_first(self, mock_run: MagicMock) -> None:
    ...
    @patch("network.ip_routing.run_command")
    def test_no_inet_addresses(self, mock_run: MagicMock) -> None:
...
class TestGetAllIpv6Addresses:
    ...
    @patch("network.ip_routing.run_command")
    def test_parse_global_ipv6(self, mock_run: MagicMock) -> None:
    ...
    @patch("network.ip_routing.run_command")
    def test_ignore_link_local(self, mock_run: MagicMock) -> None:
    ...
    @patch("network.ip_routing.run_command")
    def test_ignore_temporary(self, mock_run: MagicMock) -> None:
    ...
    @patch("network.ip_routing.run_command")
    def test_ignore_deprecated(self, mock_run: MagicMock) -> None:
...
class TestGetRouteInfo:
    ...
    @patch("network.ip_routing.run_command")
    def test_route_with_explicit_metric(self, mock_run: MagicMock) -> None:
    ...
    @patch("network.ip_routing.run_command")
    def test_route_without_metric(self, mock_run: MagicMock) -> None:
    ...
    @patch("network.ip_routing.run_command")
    def test_route_without_gateway(self, mock_run: MagicMock) -> None:
...
class TestGetActiveInterface:
    ...
    @patch("network.ip_routing.run_command")
    def test_single_default_route(self, mock_run: MagicMock) -> None:
    ...
    @patch("network.ip_routing.run_command")
    def test_multiple_routes_lowest_metric(self, mock_run: MagicMock) -> None:
...
default via 10.8.0.1 dev tun0 metric 50"""
    ...
    @patch("network.ip_routing.run_command")
    def test_multiple_routes_default_metric(self, mock_run: MagicMock) -> None:
...
default via 10.8.0.1 dev tun0 metric 50"""
    ...
    @patch("network.ip_routing.run_command")
    def test_all_default_metrics_returns_first(self, mock_run: MagicMock) -> None:
