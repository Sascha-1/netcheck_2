...
class TestRunCommand:
    ...
    @patch("subprocess.run")
    def test_value_error(self, mock_run) -> None:
    ...
    @patch("subprocess.run")
    def test_runtime_error(self, mock_run) -> None:
    ...
    @patch("subprocess.run")
    def test_shell_false_always(self, mock_run) -> None:
    ...
    @patch("subprocess.run")
    def test_output_stripped(self, mock_run) -> None:
...
class TestSanitizeForLog:
    ...
    def test_remove_ansi_escapes(self) -> None:
    ...
    def test_security_log_injection(self) -> None:
