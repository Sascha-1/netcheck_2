...
class TestExitCode:
    ...
    def test_exit_code_comparison(self) -> None:
    ...
    def test_exit_code_in_range(self) -> None:
...
class TestDeviceTechnicalTerms:
    ...
    def test_device_terms_are_strings(self) -> None:
...
class TestTableConfiguration:
    ...
    def test_table_columns_is_list(self) -> None:
        """Test TABLE_COLUMNS is a list."""
        assert isinstance(TABLE_COLUMNS, list)

    def test_table_columns_not_empty(self) -> None:
        """Test TABLE_COLUMNS has entries."""
        assert len(TABLE_COLUMNS) > 0

    def test_table_columns_structure(self) -> None:
    ...
    def test_column_separator_is_string(self) -> None:
        """Test COLUMN_SEPARATOR is a string."""
        assert isinstance(COLUMN_SEPARATOR, str)

    def test_column_separator_length(self) -> None:
...
class TestToolMetadata:
    ...
    def test_tool_name_not_empty(self) -> None:
        """Test TOOL_NAME is not empty."""
        assert len(TOOL_NAME) > 0

    def test_tool_name_lowercase(self) -> None:
...
class TestConfigurationIntegrity:
    ...
    def test_no_duplicate_corporate_suffixes(self) -> None:
        """Test no duplicate corporate suffixes."""
        assert len(CORPORATE_SUFFIXES) == len(set(CORPORATE_SUFFIXES))

    def test_no_duplicate_device_terms(self) -> None:
